    ...
    def save_settings(self):
        ...
        try:
            ...
            lib_settings.update({
                ...
                "viewNew": getattr(self.mw.sidebar, 'combo_view_mode', None) and self.mw.sidebar.combo_view_mode.currentIndex() == 3,
                "viewDlc": getattr(self.mw.sidebar, 'combo_view_mode', None) and self.mw.sidebar.combo_view_mode.currentIndex() == 4,
